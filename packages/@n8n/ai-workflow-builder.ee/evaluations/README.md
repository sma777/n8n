...
The `langsmith` object (only present in LangSmith mode) contains IDs for constructing comparison URLs:
- **Experiment comparison URL:** `https://smith.langchain.com/o/{org_id}/datasets/{datasetId}/compare?selectedSessions={experimentId}`
